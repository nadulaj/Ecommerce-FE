...
export class FileUploadComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild('fileUploadDropbox', { static: false }) dropbox?: ElementRef;
  @ViewChild('fileUploadField', { static: false }) upload_field?: ElementRef;
  ...
  constructor(private renderer2: Renderer2) {
    // this.unlistenClick: () => void;
    // this.unlistenDragEnter: () => void;
    // this.unlistenDragLeave: () => void;
    // this.unlistenDragOver: () => void;
    // this.unlistenDrop: () => void;
  }
  ...
  ngAfterViewInit(): void {
    ...
    this.unlistenDragEnter = this.renderer2.listen(
      dropbox_el,
      'dragenter',
      this.onDragEnter.bind(this)
    );
    this.unlistenDragLeave = this.renderer2.listen(
      dropbox_el,
      'dragleave',
